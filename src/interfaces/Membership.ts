...
export interface GroupInterface { id?: string, name?: string, categoryName?: string, memberCount?: number, trackAttendance?: boolean, parentPickup?: boolean, printNametag?: boolean, about?: string, photoUrl?: string, tags?: string }
